...
os.chdir(r'F:\Code Clause\Music Player in Python\MusicPlayer\songs')
songs = os.listdir()


button_image_1 = PhotoImage(file=r"F:\Code Clause\Music Player in Python\MusicPlayer\images\\button_1.png")
...
resume_pic = PhotoImage(
    file=r"F:\Code Clause\Music Player in Python\MusicPlayer\images\\button_2.png")
